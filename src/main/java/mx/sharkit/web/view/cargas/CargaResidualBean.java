...
@Named
@ViewScoped
public class CargaResidualBean implements Serializable, Observer {

    private static final Logger LOGGER = Logger.getLogger(CargaResidualBean.class.getName());
    private static final String CLAVE_PROCESO = "ARCHIVOS_CARGA";
    private static final String CLAVE_SCRIPT = "CARGA_RESIDUAL";
        ...
        try {
            ...
            if (errores.isEmpty()) {
                if (!chips.isEmpty()) {
                    ...
                    Integer actualizados = chipResidualService.saveResidual(chips);
