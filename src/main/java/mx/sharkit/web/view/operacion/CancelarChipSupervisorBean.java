...
@Named
@ViewScoped
public class CancelarChipSupervisorBean implements Serializable {

    private static final Logger LOG = Logger.getLogger(CancelarChipSupervisorBean.class.getName());
        ...
        try {
            if (StringUtils.equals("SSID", tipoAsignacion)) {
                ...
                if (chip != null) {
                    ...
                    if (Objects.equals(chip.getEstatusId(), Estatus.ID_ESTATUS_VENDIDO)) {
                        ...
                        if (Objects.equals(chip.getUsuarioSupervisorId(), idSupervisor)) {
                            ...
                            if (chipHistoricoService.saveChipAndHistory(chip, historicoEstatus)) {
                                obtenerChips();
                                PFMessages.showMessageInfo("El chip con numero: " + serie + " ha sido cancelado correctamente");
                                cleanSearch();
                            } else {
                        ...
                        PFMessages.showMessageError("El chip con numero: " + serie + " no se encuentra en estatus: Vendido");
                        System.out.println("El chip con numero: " + serie + " no se encuentra en estatus: vendido");
                    }
                ...
                Integer noActualizados = chipService.cancelarChipsSubdistribuidorByRango(serie, serieFinal,
                        idSupervisor, observaciones, userDetails.getUsername());
                obtenerChips();
                cleanSearch();
                PFMessages.showMessageInfo("Se cancelaron: " + noActualizados + " chip(s).");
    ...
    public void obtenerChips() {
        try {
            ...
            dc.add(Restrictions.eq("estatusId", Estatus.ID_ESTATUS_CANCELADO));
